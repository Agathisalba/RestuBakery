...
(function($) {
    ...
    $.fn.mapify = function(options) {
        ...
        if (!googleLoaded || !googleLoading) {
            ...
            //API key javascript untuk map
            $.getScript('https://maps.googleapis.com/maps/api/js?key=AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&callback=initMap&v=weekly', function() {
